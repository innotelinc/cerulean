...
/**
 * Minimal HashiCorp Vault client (KV v2 engine). Cerulean's secret vault:
 *
...
class VaultClient {
  ...
  /**
   * Resolve a single .env-style value. `vault://<path>#<key>` reads from
   * HashiCorp Vault; anything else is returned unchanged.
   */
